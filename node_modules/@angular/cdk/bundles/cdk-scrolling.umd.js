(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/cdk/platform'),require('@angular/cdk/bidi'),exports, require('@angular/cdk/coercion'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/platform'), require('@angular/cdk/bidi'), require('tslib'), require('@angular/cdk/collections')) :
    typeof define === 'function' && define.amd ? define('@angular/cdk/scrolling', ['@angular/core','@angular/cdk/platform','@angular/cdk/bidi','exports', '@angular/cdk/coercion', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/cdk/platform', '@angular/cdk/bidi', 'tslib', '@angular/cdk/collections'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.cdk.platform,global.ng.cdk.bidi,(global.ng = global.ng || {}, global.ng.cdk = global.ng.cdk || {}, global.ng.cdk.scrolling = {}), global.ng.cdk.coercion, global.ng.core, global.rxjs, global.rxjs.operators, global.ng.cdk.platform, global.ng.cdk.bidi, global.tslib, global.ng.cdk.collections));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, coercion, i0, rxjs, operators, i1, bidi, tslib, collections) { 
...
ScrollingModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ScrollingModule_Factory(t) { return new (t || ScrollingModule)(); }, imports: [[bidi.BidiModule, i1.PlatformModule], ɵngcc2.BidiModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ScrollingModule, { declarations: [CdkFixedSizeVirtualScroll,
        CdkScrollable,
        CdkVirtualForOf,
        CdkVirtualScrollViewport], imports: [ɵngcc2.BidiModule, ɵngcc1.PlatformModule], exports: [ɵngcc2.BidiModule, CdkFixedSizeVirtualScroll,
        CdkScrollable,
        CdkVirtualForOf,
